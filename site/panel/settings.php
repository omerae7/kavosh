...
?>
  <?php if ($first): ?>
  <div class="pc" style="margin-bottom:16px;border-color:#EFCFC9">
    <div class="pc-b" style="background:var(--danger-soft)">
  ...
  <div class="pc" style="margin-bottom:16px">
    <div class="pc-h"><h3>بخش‌ها</h3><span class="sp"></span>
    ...
    <div class="pc-b" id="pane"><div class="empty">در حال بارگذاری…</div></div>
  </div>
