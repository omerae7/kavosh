  ...
  var Store = {
    load: function () {
      ...
      try {
        ...
        if (!d || !d.rows || d.rows.length !== 5) return false;
        var base = newState();
        S.meta = Object.assign(base.meta, d.meta || {});
        S.customer = Object.assign(base.customer, d.customer || {});
        S.rows = d.rows.map(function (r) { return Object.assign(newRow(), r); });
        return true;
  ...
  var UI = {
    build: function () {
      ...
      main.appendChild(el('div', 'foot',
        'این فایل کاملاً آفلاین کار می‌کند؛ برای انتقال کافی است همین فایل را کپی کنید. ' +
        'مبالغ به <b>ریال</b> است.'));
      UI.refreshAll();
    },
